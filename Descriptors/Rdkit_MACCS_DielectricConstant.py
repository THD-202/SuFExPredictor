...
des_Al = df['MS']
des_MW = df['MW']
des_com = pd.concat([des_base, des_base_eq, des_diff, des_Reactant1_eq, des_solvent1, des_ET, des_Addictive1,
...
des_com.to_csv('dataset_Rdkit_MACCS_DielectricConstant.csv', index=False, header=False)
end = datetime.now()
print(des_com.shape)
