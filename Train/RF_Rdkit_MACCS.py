...
def load_data(data_name, fp_name):
	...
	for train_index,val_index in kf.split(X_train,Y_train):
		...
		model = RandomForestRegressor(n_estimators=900, bootstrap = False, n_jobs = 12, max_depth=270, max_features=0.2610900834468623, min_samples_leaf=1, min_samples_split=0.0018381508262608852)
